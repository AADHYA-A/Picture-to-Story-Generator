        ...
        with gr.Row():
            with gr.Accordion("Expand for examples:", open=False):
                gr.Examples(
                    examples=[
                        [
                            "assets/examples/nature-wolf.jpg",
                            "Poetry",
                            "Symbolic",
                            80,
                            0.8,
                        ...
                        [
                            "assets/examples/emotions-portrait.jpg",
                            "Fiction",
                            "Cinematic",
                            100,
                            0.7,
                        ...
                        [
                            "assets/examples/fantasy-forest.jpg",
                            "Surrealism",
                            "Non-linear",
                            120,
                            1.0,
                        ...
                        [
                            "assets/examples/city-night.jpg",
                            "Horror",
                            "Narrative",
                            90,
                            0.6,
                        ...
                        [
                            "assets/examples/adventure-mountain.jpg",
                            "Children Literature",
                            "Experimental",
                            70,
                            0.9,
